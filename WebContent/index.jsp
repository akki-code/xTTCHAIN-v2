...
<header role="banner">
	...
	<nav class="main-nav">
		<ul>
			...
			<a href="http://slides.com/sunnythakur/deck/fullscreen"><input type="button" class="button button2" value="Presentation ->">
			</a>
			<a href="http://knowing-archer.gitch.com"><input type="button" class="button button2" value="3D  model">
			</a>
		</ul>
	</nav>
</header>
...
<div style="margin-top:0.8em;" >
    <h1 style="background-color:#343642;color:antiquewhite;height:40px;width:100%;font-size:20px;text-align:center;padding-top:6px;">A Solution By xCODs. -Anjani -Ankit -Akshay</h1></footer>
</div>
